...
/// trace schema.
///
/// This deliberately does NOT reuse `dzzy_core::CommunityId`. Two reasons:
///
/// 1. **Production fence preservation.** `dzzy_core::CommunityId` has no
...
impl CommunityLabel {
    /// Wrap a UUID into a community label. Unlike `dzzy_core::CommunityId`
