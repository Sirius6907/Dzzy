...
pub const CACHE_INVALIDATION_PATTERN: &str = "dzzy:*:cache-invalidate";
...
pub fn cache_invalidation_channel(ctx: &TenantContext) -> String {
    format!(
        "{DZZY_PREFIX}:{}:{CACHE_INVALIDATION_SUFFIX}",
        ctx.community()
    )
}
...
/// Subscribes to `dzzy:*:cache-invalidate` and forwards scoped drops to the broadcast.
///
...
mod tests {
    ...
    fn cache_invalidation_channel_is_community_scoped() {
        ...
        assert_eq!(
            ...
            format!("dzzy:{}:cache-invalidate", community_a.community())
        );
        assert_ne!(
            cache_invalidation_channel(&community_a),
    ...
    fn parses_cache_invalidation_channel() {
        ...
        let raw = format!("dzzy:{community_id}:cache-invalidate");
    ...
    fn rejects_bad_cache_invalidation_channels() {
        for raw in [
            "dzzy:cache-invalidate",
            "dzzy:not-a-uuid:cache-invalidate",
            "not-dzzy:00000000-0000-0000-0000-00000000aaaa:cache-invalidate",
            "dzzy:00000000-0000-0000-0000-00000000aaaa:cache-invalidate:extra",
            "dzzy:00000000-0000-0000-0000-00000000aaaa:channel:00000000-0000-0000-0000-00000000bbbb",
        ] {
