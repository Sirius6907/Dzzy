...
//! Minimal NIP-01 WebSocket test client for the Dzzy relay.
...
use dzzy_ws_client::NostrWsConnection;
pub use dzzy_ws_client::{parse_relay_message, OkResponse, RelayMessage, WsClientError};

/// Errors returned by [`DzzyTestClient`] operations.
#[derive(Debug, Error)]
...
/// WebSocket test client for integration testing against a running Dzzy relay.
pub struct DzzyTestClient {
