...
//! # Run one binary, DZZY_HEALTH_PORT=8180 DZZY_METRICS_PORT=9202,
//! # DZZY_RECONCILE_CHANNELS=false, DZZY_GIT_CONFORMANCE_PROBE=false
//! ```
//!
//! Each test is `#[ignore]` so it only runs explicitly:
//! `cargo test -p dzzy-test-client --test nip42_host_binding_live -- --ignored --test-threads=1`
