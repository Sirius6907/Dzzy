...
//!
//! Crash report (2026-07-08, dzzy-desktop 0.3.46): enabling Share compute
...
//!
//!   cargo run -p dzzy-relay --example mesh_stack_smoke
...
/// Must match `dzzy_lib::mesh_llm::MESH_WORKER_STACK_SIZE` (desktop crate is
/// not a dependency of dzzy-relay, so the value is duplicated here).
