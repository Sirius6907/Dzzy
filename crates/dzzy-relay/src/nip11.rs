...
/// enforces membership (`DZZY_REQUIRE_RELAY_MEMBERSHIP=true`) AND has a
...
impl RelayInfo {
    ...
    /// kinds 39000/39001/39002, which Dzzy signs with `state.relay_keypair`
    ...
    pub fn build(
        ...
        Self {
            name: "Dzzy Relay".to_string(),
            description: "Dzzy — private team communication relay".to_string(),
            ...
            push: None,
            software: "https://github.com/Sirius6907/dzzy".to_string(),
...
fn push_descriptor(
    ...
    Some(serde_json::json!({
        ...
        "app_profiles": [
            {"id": "dzzy-ios-production", "transport": "apns"},
            {"id": "dzzy-ios-sandbox", "transport": "apns"}
        ],
...
mod tests {
    ...
    #[test]
    fn build_advertises_dzzy_repository_url() {
        let info = RelayInfo::build(None, None, false, DEFAULT_MAX_FRAME_BYTES, None);
        assert_eq!(info.software, "https://github.com/Sirius6907/dzzy");
    }
    ...
    fn auth_required_is_advertised_true() {
        ...
        // `AuthState::Authenticated` (see `crates/dzzy-relay/src/handlers/`),
