#![deny(unsafe_code)]
#![warn(missing_docs)]
//! NIP-01 WebSocket relay for Dzzy private team communication.
...
/// `docs/spec/MultiTenantRelay.tla` by the independent `dzzy-conformance`
/// checker.
pub mod conformance;
...
/// Inter-relay mesh startup wiring (`DZZY_MESH` seam).
pub mod mesh_boot;
...
/// Workflow action sink — relay-side implementation of [`dzzy_workflow::ActionSink`].
