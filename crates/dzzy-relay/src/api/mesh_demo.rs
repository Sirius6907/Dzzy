...
//!
//! This is the *client leg* of the `DZZY_MESH_DEMO_ECHO` evidence run: the
...
//!
//! - Gated on **both** `DZZY_MESH_DEMO_ECHO=on` and mesh enabled; 404
...
use dzzy_relay_mesh::RelayPeerTransport;
