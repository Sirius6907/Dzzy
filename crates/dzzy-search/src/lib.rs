#![deny(unsafe_code)]
#![warn(missing_docs)]
//! Dzzy search — community-scoped Postgres full-text search over Dzzy events.
//!
...
//! by `dzzy-db`. The relay refetches canonical events through `dzzy-db`'s
