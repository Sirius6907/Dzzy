...
///   `str_ends_with`, `str_len` (duplicated intentionally from dzzy-workflow).
...
/// `str_len` — duplicated from dzzy-workflow intentionally so this crate
/// has no runtime dependency on dzzy-workflow.
