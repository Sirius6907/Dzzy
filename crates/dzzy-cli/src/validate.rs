...
pub fn sdk_err(e: dzzy_sdk::SdkError) -> CliError {
    match e {
        dzzy_sdk::SdkError::InvalidInput(msg) => CliError::Usage(msg),
...
mod tests {
    ...
    // and `normalize_mention_pubkeys` live in `dzzy_sdk::mentions` and are tested there.
