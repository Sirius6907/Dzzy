#![deny(unsafe_code)]
#![warn(missing_docs)]
//! `dzzy-sdk` — typed Nostr event builders for Dzzy operations.
//!
//! # Mental Model
//!
//! ```text
...
/// Re-export kind constants so consumers don't need dzzy-core directly.
pub use dzzy_core::kind;
...
pub use dzzy_core::channel::canonical_channel_name;
/// Channel type.
pub use dzzy_core::channel::ChannelType as ChannelKind;
/// Channel visibility.
pub use dzzy_core::channel::ChannelVisibility as Visibility;
/// Member role.
pub use dzzy_core::channel::MemberRole;
