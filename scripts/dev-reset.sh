...
# Installed Dzzy state is preserved.
# =============================================================================
set -euo pipefail
...
if [[ "${1:-}" != "--yes" ]]; then
  ...
  echo -e "   Installed Dzzy app state and its production keyring are preserved."
...
success "Desktop development state removed (installed Dzzy state preserved)"
