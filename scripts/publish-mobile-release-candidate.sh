...
[[ "$repo" == "block/dzzy" ]] || fail "candidate publishing is restricted to block/dzzy"
...
message="Dzzy Mobile $version release candidate $candidate_number"
tag_object_sha="$(
...
printf 'Published %s at %s through dzzy-release-bot.\n' "$tag" "$target_sha"
