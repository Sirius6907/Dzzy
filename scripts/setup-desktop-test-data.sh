...
DB_HOST="${DZZY_DB_HOST:-127.0.0.1}"
DB_PORT="${DZZY_DB_PORT:-5432}"
DB_USER="${DZZY_DB_USER:-dzzy}"
DB_PASS="${DZZY_DB_PASS:-dzzy_dev}"
DB_NAME="${DZZY_DB_NAME:-dzzy}"
DB_DOCKER_CONTAINER="${DZZY_DB_DOCKER_CONTAINER:-dzzy-postgres}"
...
COMMUNITY_HOST="${DZZY_COMMUNITY_HOST:-localhost:3000}"
...
UUID_GENERAL=$(uuid5_hex "dzzy.channel.general")
UUID_RANDOM=$(uuid5_hex "dzzy.channel.random")
UUID_ENGINEERING=$(uuid5_hex "dzzy.channel.engineering")
UUID_AGENTS=$(uuid5_hex "dzzy.channel.agents")
UUID_WATERCOOLER=$(uuid5_hex "dzzy.channel.watercooler")
UUID_ANNOUNCEMENTS=$(uuid5_hex "dzzy.channel.announcements")
UUID_DM_ALICE_TYLER=$(uuid5_hex "dzzy.channel.dm.alice-tyler")
UUID_DM_BOB_TYLER=$(uuid5_hex "dzzy.channel.dm.bob-tyler")
UUID_DM_BOB_CHARLIE_TYLER=$(uuid5_hex "dzzy.channel.dm.bob-charlie-tyler")
