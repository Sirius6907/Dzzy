...
If you discover a security vulnerability in Dzzy, please report it by emailing
**dzzy@block.xyz**. Include as much detail as possible:
...
Dzzy is pre-1.0. We do not maintain long-term support branches at this stage.
...
All events are written to a tamper-evident audit log (`dzzy-audit`). Each
...
The Dzzy desktop app stores nsec private keys in the operating system keyring
...
example), keys fall back to a `0o600` owner-only file. The `DZZY_PRIVATE_KEY`
