...
A minimal three-agent persona pack for Dzzy.
...
```bash
# Validate the pack
dzzy pack validate ./examples/meadow-core

# Inspect resolved config
dzzy pack inspect ./examples/meadow-core
...
See `crates/dzzy-persona/PERSONA_PACK_SPEC.md` for the full format reference.
