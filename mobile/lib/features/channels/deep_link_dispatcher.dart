...
/// Routes pending `dzzy://message` deep links into the channel view.
///
...
class _DeepLinkDispatcherState extends ConsumerState<DeepLinkDispatcher> {
  ...
  Widget build(BuildContext context) {
    ...
    ref.listen<DzzyDeepLink?>(pendingDeepLinkProvider, (_, link) {
      _maybeDispatch(link);
    });
  ...
  void _maybeDispatch(DzzyDeepLink? link) {
    if (link == null) return;
