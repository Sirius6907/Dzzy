...
const bool mockDmDirectoryEnabled =
    kDebugMode && bool.fromEnvironment('DZZY_MOCK_DM_DIRECTORY');
...
///
/// Dzzy relays use `member` tags, while older NIP-29-compatible relays may
