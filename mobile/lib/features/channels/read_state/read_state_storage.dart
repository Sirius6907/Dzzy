...
const _clientIdKeyPrefix = 'dzzy.nip-rs.client-id';
const _slotIdKeyPrefix = 'dzzy.nip-rs.slot-id';
const _uuid = Uuid();

String localReadStateKey(String pubkey) => 'dzzy.channel-read-state.v2:$pubkey';

String localPublishableContextKey(String pubkey) =>
    'dzzy.channel-read-state.publishable.v1:$pubkey';

String localSourceCreatedAtKey(String pubkey) =>
    'dzzy.channel-read-state.source-created-at.v1:$pubkey';
