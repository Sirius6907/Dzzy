...
import 'package:dzzy/features/pairing/pairing_page.dart';
...
void main() {
  group('PairingPage', () {
    testWidgets('renders branding, scan button, divider, and text field', (
      ...
      expect(
        find.image(const AssetImage('assets/images/dzzy-icon.png')),
        findsOneWidget,
      );
      expect(find.text('Welcome to Dzzy'), findsOneWidget);
