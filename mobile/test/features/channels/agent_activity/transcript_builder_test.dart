...
import 'package:dzzy/features/channels/agent_activity/observer_models.dart';
import 'package:dzzy/features/channels/agent_activity/transcript_builder.dart';
...
void main() {
  ...
  test('normalizes dzzy tool calls and applies result updates', () {
    final items = buildTranscript([
      _updateFrame(
        seq: 1,
        update: {
    ...
    expect(tool.dzzyToolName, 'send_message');
  ...
  test('parses dzzy prompt text into user message and metadata', () {
    final items = buildTranscript([
      ObserverFrame(
        seq: 1,
