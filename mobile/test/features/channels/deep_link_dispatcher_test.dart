...
import 'package:dzzy/features/channels/deep_link_dispatcher.dart';
import 'package:dzzy/features/invites/invite_join_provider.dart';
import 'package:dzzy/shared/auth/auth.dart';
import 'package:dzzy/shared/deeplink/deep_link.dart';
import 'package:dzzy/shared/deeplink/pending_deep_link_provider.dart';
...
void main() {
  ...
  testWidgets('prepares an invite once while listeners re-enter', (
    ...
    expect(find.text('Join this Dzzy community?'), findsOneWidget);
  });
...
class _RecordingPendingDeepLinkNotifier extends PendingDeepLinkNotifier {
  ...
  final DzzyDeepLink link;
  int consumeCalls = 0;

  @override
  DzzyDeepLink? build() => link;
