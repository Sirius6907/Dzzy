...
--     (crates/dzzy-db/src/push.rs: accept_lease_event and replace_lease).
...
--   * Lock key domain 'dzzy_push_gate:' is distinct from the audit lock
--     ('dzzy_audit:') and both lease-address lock families.
