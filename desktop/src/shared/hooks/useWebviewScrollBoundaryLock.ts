...
const CONVERSATION_SCROLL_SELECTOR = "[data-dzzy-conversation-scroll]";
 ...
 *
 * Dzzy is laid out as fixed-height nested panes. On macOS, a wheel/trackpad
 ...
 * boundaries, only containers marked with `data-dzzy-conversation-scroll` are
