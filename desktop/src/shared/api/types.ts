...
export type ManagedAgent = {
  ...
  /** Who the agent should respond to. Maps to `dzzy-acp --respond-to`. */
...
/**
 * Inbound author gate mode. Mirrors `dzzy-acp`'s `--respond-to` CLI flag.
...
export type AgentPersona = {
  ...
  runtime: string | null;
  /** Opaque, harness-specific model identifier string. Dzzy stores and passes through without interpretation. */
  model: string | null;
