...
export const chromeCssVars = {
  topChromeHeight: "--dzzy-top-chrome-height",
  channelContentTopPadding: "--dzzy-channel-content-top-padding",
} as const;
...
export const topChromeBackdrop = {
  ...
  height: "h-(--dzzy-top-chrome-height,40px)",
  /** `after:` pseudo-element offset aligned to the bottom of top chrome. */
  dividerTop: "after:top-(--dzzy-top-chrome-height,40px)",
} as const;
...
export const channelChrome = {
  ...
  contentPadding: "pt-(--dzzy-channel-content-top-padding,5.75rem)",
  /** Absolute/fixed top offset below the measured channel header chrome. */
  top: "top-(--dzzy-channel-content-top-padding,5.75rem)",
  /** Height matching the measured channel header chrome. */
  headerHeight: "h-(--dzzy-channel-content-top-padding,5.75rem)",
  /** Negative margin for overlaid channel chrome that should not affect flow. */
  negativeMargin: "-mb-(--dzzy-channel-content-top-padding,5.75rem)",
} as const;
