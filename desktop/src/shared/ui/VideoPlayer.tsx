...
const TIMECODE_ACCENT_CLASS =
  "bg-[hsl(var(--dzzy-video-review-accent,var(--primary))/0.15)] text-[hsl(var(--dzzy-video-review-accent-foreground,var(--dzzy-video-review-accent,var(--primary))))]";
const TIMECODE_ACCENT_HOVER_CLASS =
  "hover:bg-[hsl(var(--dzzy-video-review-accent,var(--primary))/0.3)]";
