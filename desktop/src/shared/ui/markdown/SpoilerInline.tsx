...
export function SpoilerInline({
  ...
  if (!interactive) {
    if (isBlock) {
      return (
        <div
          className="dzzy-spoiler dzzy-spoiler--block dzzy-spoiler--inert"
          data-revealed="false"
          data-spoiler=""
        >
          <SpoilerParticles active contentRef={contentRef} />
          <div className="dzzy-spoiler__content" ref={setContentElement}>
    ...
    return (
      <span
        className="dzzy-spoiler dzzy-spoiler--inert"
        data-revealed="false"
        data-spoiler=""
      >
        <SpoilerParticles active contentRef={contentRef} />
        <span className="dzzy-spoiler__content" ref={setContentElement}>
          <SpoilerHiddenContext.Provider value={true}>
            {children}
          </SpoilerHiddenContext.Provider>
        </span>
  ...
  if (isBlock) {
    return (
      <div
        {...revealProps}
        className="dzzy-spoiler dzzy-spoiler--block"
