 ...
 * - Default padding is the safe inset (`--dzzy-card-textured-safe-inset`),
  ...
  variants: {
    variant: {
      ...
      textured:
        ...
        "dzzy-card-textured relative isolate flex flex-col justify-center rounded-none border-0 p-[var(--dzzy-card-textured-safe-inset)] shadow-none",
    },
  },
  defaultVariants: {
    variant: "default",
