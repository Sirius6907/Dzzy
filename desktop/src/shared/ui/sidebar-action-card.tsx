...
function SidebarActionDescriptionText({
  ...
  if (shouldReduceMotion || !transition.isAnimating) {
    return (
      <span className="dzzy-sidebar-action-description">
        {transition.current}
      </span>
    );
  }
  ...
  return (
    <span className="dzzy-sidebar-action-description">
      ...
      <span aria-hidden className="dzzy-sidebar-action-description__motion">
        <span
          className="dzzy-sidebar-action-description__reel"
    ...
    >
      <button
        ...
        className={cn(
          ...
          isSuccess
            ? "dzzy-sidebar-action-card--success disabled:cursor-default disabled:opacity-100"
            : surface === "secondary"
      ...
      >
        ...
        <motion.span
          className={cn(
            ...
            isSuccess
              ? "dzzy-sidebar-action-card__success-icon"
