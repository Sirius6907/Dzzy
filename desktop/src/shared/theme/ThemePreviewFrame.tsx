...
/**
 * Dzzy sidebar-gradient stop tokens, keyed by theme name. The actual custom
 ...
 */
export const DZZY_GRADIENT_STOPS: Record<
  string,
  { top: string; bottom: string }
> = {
  dzzy: {
    top: "var(--dzzy-gradient-light-top)",
    bottom: "var(--dzzy-gradient-light-bottom)",
  },
  "dzzy-dark": {
    top: "var(--dzzy-gradient-dark-top)",
    bottom: "var(--dzzy-gradient-dark-bottom)",
  },
};
...
function SystemPreferencePreviewSvg({
  ...
  const lightGradientId = `${clipBase}-dzzy-light`;
  const darkGradientId = `${clipBase}-dzzy-dark`;
