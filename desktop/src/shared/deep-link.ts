...
/**
 * Payload emitted by the Rust deep-link handler for `dzzy://message?…`.
...
/**
 * Payload emitted by the Rust deep-link handler for `dzzy://join?…` —
 ...
 *
 * When a `dzzy://connect?relay=<url>` link is opened, the handler
 ...
 *
 * When a `dzzy://join?relay=<url>&code=<invite>` link is opened (relay
 ...
 *
 * `dzzy://message?…` is handled separately by `listenForMessageDeepLinks`,
