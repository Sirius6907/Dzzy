...
function resetDevWebviewStateFromUrl() {
  ...
  // WebKit groups every Dzzy binary under one disk directory, but storage is
...
function configureDevE2eBridgeFromUrl() {
  ...
  e2eWindow.__DZZY_E2E__ ??= { mode: "mock" };
  ...
  window.localStorage.setItem("dzzy-active-community-id", E2E_COMMUNITY_ID);
    ...
    <React.StrictMode>
      <CommunitiesProvider>
        <CommunityOnboardingProvider>
          <ThemeProvider defaultTheme="dzzy">
...
async function installE2eBridgeIfConfigured() {
  ...
  if (
    ...
    !(window as E2eWindow).__DZZY_E2E__
  ) {
    return;
  }
