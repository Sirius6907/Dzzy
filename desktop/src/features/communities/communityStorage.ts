...
const COMMUNITIES_KEY = "dzzy-communities";
const ACTIVE_COMMUNITY_KEY = "dzzy-active-community-id";
const LEGACY_WORKSPACES_KEY = "dzzy-workspaces";
const LEGACY_ACTIVE_WORKSPACE_KEY = "dzzy-active-workspace-id";
...
export function deriveCommunityName(relayUrl: string): string {
  try {
    ...
    // Detect staging environments (e.g. dzzy-oss.stage.blox.sqprod.co)
