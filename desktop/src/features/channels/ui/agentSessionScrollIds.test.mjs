 ...
 *  tree transitively imports a .css file (DzzyLogoAnimation.tsx →
 *  dzzy-logo-animation.css) and the test-loader has no CSS stub. The
...
// DzzyLogoAnimation.tsx → dzzy-logo-animation.css). The test below verifies the
