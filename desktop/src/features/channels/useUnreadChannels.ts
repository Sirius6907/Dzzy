...
const participationStore = makeRootIdStore("dzzy-thread-participation.v1");
const authoredStore = makeRootIdStore("dzzy-thread-authored.v1");
...
const mentionedStore = makeRootIdStore("dzzy-thread-mentioned.v1");
const mutedStore = makeRootIdStore("dzzy-thread-muted.v1");
...
export function useUnreadChannels(
  ...
  // (dzzy-forced-unread.v1) so it survives reload and is visible to the rail
