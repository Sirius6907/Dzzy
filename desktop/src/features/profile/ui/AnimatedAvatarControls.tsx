...
export function AvatarFramingSlider({
  ...
  const sliderControl = (
    <div className="dzzy-avatar-framing-slider-wrapper">
      <div
        ...
        aria-valuemin={min}
        aria-valuenow={value}
        className="dzzy-avatar-framing-slider"
        ...
        style={
          {
            "--dzzy-avatar-framing-slider-fill": `${fill}%`,
          } as React.CSSProperties
        }
        tabIndex={disabled ? -1 : 0}
      >
        <div className="dzzy-avatar-framing-slider-hashmarks">
          {ticks.map((tick) => (
            <span
              aria-hidden="true"
              className="dzzy-avatar-framing-slider-hashmark"
              key={tick}
              style={{
        ...
        <div aria-hidden="true" className="dzzy-avatar-framing-slider-fill" />
        <div aria-hidden="true" className="dzzy-avatar-framing-slider-handle" />
      </div>
      <button
      ...
      {tipText ? (
        <p
          className="dzzy-avatar-framing-slider-tip"
