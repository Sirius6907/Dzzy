...
const NOTIFICATION_SETTINGS_STORAGE_KEY = "dzzy-notification-settings.v2";
      ...
      if (nextPermission !== "granted") {
        ...
        setErrorMessage(
          nextPermission === "denied"
            ? "Desktop notifications are blocked for Dzzy. Enable them in system settings to turn alerts on."
