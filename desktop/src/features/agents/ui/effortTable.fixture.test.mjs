 ...
 * matches every entry. Drift between `dzzyAgentConfig.ts` and the fixture
 * (e.g. a new model family added to one side but not the other) fails CI.
 * The companion Rust test in `crates/dzzy-agent/src/config.rs` mirrors
...
import { getProviderEffortConfig } from "./dzzyAgentConfig.ts";
