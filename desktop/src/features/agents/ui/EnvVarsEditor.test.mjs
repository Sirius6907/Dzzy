...
test("inheritedRows_structured_keys_excluded_from_generic_rows", () => {
  // DZZY_AGENT_PROVIDER, DZZY_AGENT_MODEL, DZZY_AGENT_THINKING_EFFORT must
  ...
  const allBaked = [
    ...
    { key: "DZZY_AGENT_MODEL", value: "goose-claude-opus-4-8", masked: false },
    { key: "DZZY_AGENT_THINKING_EFFORT", value: "medium", masked: false },
    {
      key: "DATABRICKS_HOST",
      value: "https://example.databricks.com/",
      masked: false,
