...
import { getDzzyToolInfo } from "../agentSessionToolCatalog";
...
export function ToolItem({
  ...
  const canonicalToolName = item.dzzyToolName ?? item.toolName;
  const dzzyTool = getDzzyToolInfo(canonicalToolName);
