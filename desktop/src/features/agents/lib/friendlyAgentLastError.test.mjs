...
test("dzzy-acp wrapped auth failure → denied copy", () => {
...
test("unwrapped dzzy-agent prefix → denied copy", () => {
  // dzzy-agent's AgentError::LlmAuth Display is "llm auth: <body>"; if the
...
test("code -32001 → Dzzy shared compute denied copy (structured path)", () => {
