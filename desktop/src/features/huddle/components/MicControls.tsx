...
const splitChevronButtonClass =
  "dzzy-huddle-split-chevron group h-12 w-auto shrink-0 rounded-l-none px-2 py-4";
const MIC_PERMISSION_SETTINGS_URL =
  "x-apple.systempreferences:com.apple.preference.security?Privacy_Microphone";

type MicMeterBarStyle = CSSProperties & {
  "--dzzy-huddle-meter-height": string;
};
...
function micMeterBarStyle(heightRem: number): MicMeterBarStyle {
  return { "--dzzy-huddle-meter-height": `${heightRem}rem` };
}
    ...
    <Popover>
      ...
      >
        <Tooltip>
          <TooltipTrigger asChild>
            <Button
              ...
              className={cn(
                ...
                !isMuted && !micUnavailable && "dzzy-huddle-split-main",
              )}
              onClick={() => {
          ...
          <TooltipContent className="dzzy-huddle-tooltip" side="top">
            {micUnavailable
            ...
            {showMicMeter ? (
              ...
              >
                <span className="flex h-5 w-5 items-center justify-between text-current group-data-[state=open]:hidden group-focus-visible:hidden group-hover:hidden">
                  <span
                    className="dzzy-huddle-mic-meter-bar bg-current"
      ...
      <PopoverContent
        side="top"
        className="dzzy-huddle-drawer dzzy-huddle-popover w-64 text-foreground"
      >
      ...
      <div className="relative flex items-center">
        ...
        >
          ...
          <PopoverContent
            ...
            className="dzzy-huddle-drawer dzzy-huddle-popover dzzy-huddle-headphones-hint w-64 p-3 text-foreground"
        ...
        <Button
          ...
          className={cn(
            splitIconButtonClass,
            ttsEnabled && "dzzy-huddle-split-main",
          )}
          onClick={onToggleTts}
          size="icon"
