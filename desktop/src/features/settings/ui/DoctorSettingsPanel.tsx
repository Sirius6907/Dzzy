      ...
      >
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              This replaces the machine-wide codex-acp adapter. Older Dzzy
      ...
      <div className="min-w-0">
        ...
        {!prerequisite.available ? (
          <div className="mt-3 space-y-1 text-sm text-muted-foreground">
            <p>Required for dzzy-agent shell tools on Windows.</p>
  ...
  return (
    ...
    >
      <SectionHeader
        ...
        description="Choose which agent tools Dzzy can use on this device."
        action={
          <Button
