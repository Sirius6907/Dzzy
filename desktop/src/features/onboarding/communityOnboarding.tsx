...
const STORAGE_KEY = "dzzy-community-onboarding-transaction.v1";
...
export function markCommunityOnboardingComplete(
  ...
  storage.setItem(
    `dzzy-community-onboarding-complete.v1:${encodeURIComponent(relayUrl)}:${pubkey}`,
    "true",
  );
  ...
  storage.setItem(`dzzy-onboarding-complete.v1:${pubkey}`, "true");
}
