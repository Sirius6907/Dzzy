...
import { LandingDzzy } from "./LandingDzzy";
...
export function MachineOnboardingFlow({
  ...
  return (
    <div
      className={`dzzy-onboarding-neutral-theme dzzy-startup-shell flex max-h-dvh items-start justify-center overflow-x-hidden overflow-y-auto px-4 text-foreground ${
        page === "identity"
          ? "dzzy-onboarding-welcome py-8"
          : "pb-28 pt-[106px]"
      }`}
      data-testid="machine-onboarding-gate"
    >
      <StartupWindowDragRegion />
      {page === "identity" ? <LandingDzzy /> : null}
      {page !== "identity" ? (
        <OnboardingChrome
      ...
      <OnboardingFooterProvider>
        <div
          className={`relative flex w-full max-w-[1040px] flex-col items-center text-center ${
            page === "identity" ? "my-auto" : "dzzy-onboarding-step-frame"
          }`}
        >
          {page === "identity" ? (
              ...
              <div className="shrink-0">
                ...
                <p className="mt-5 max-w-[440px] text-sm leading-6 text-foreground/80">
                  {identityLost
                    ...
                    : "If you already have a Dzzy account, enter your private key below to get started."}
                </p>
              </div>
              <div className="dzzy-onboarding-key-import-position w-full">
                <NostrKeyImportForm
