...
export function OnboardingFlow({
  ...
  return (
    <>
      <div
        className="dzzy-onboarding-neutral-theme dzzy-startup-shell flex items-start justify-center overflow-y-auto bg-background px-4 pb-28 pt-[106px] text-foreground"
                  ...
                  {identityLost ? (
                    <>
                      ...
                      <p className="mt-5 text-sm leading-6 text-muted-foreground">
                        ...
                        Re-import your nsec to restore it — Dzzy will restart to
                    ...
                    <>
                      ...
                      <p className="mt-5 text-sm leading-6 text-muted-foreground">
                        ...
                        Dzzy. If this key already has a profile on the relay,
