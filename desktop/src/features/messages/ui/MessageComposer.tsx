...
import { getDzzyCodeBlockClipboardText } from "@/shared/lib/codeBlockClipboard";
    ...
    richText.editor.setOptions({
      editorProps: {
        ...
        handlePaste: (_view, event) => {
          ...
          // --- Dzzy code-block paste ---
          // The code block copy button writes a small Dzzy marker alongside
          ...
          const codeBlockText = getDzzyCodeBlockClipboardText(
            event.clipboardData,
          );
          ...
          // Restore Dzzy snapshots before normal styled-HTML normalization.
