...
const CLIPBOARD_ATTRIBUTE = "data-dzzy-agent-snapshot";
...
/** Build Dzzy-specific clipboard HTML with the raw URL as its visible link. */
...
/** Convert a Dzzy snapshot clipboard payload into one pending attachment. */
