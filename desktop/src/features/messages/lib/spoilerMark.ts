...
const SPOILER_MARKDOWN_RULE = "dzzy_spoiler";
const SPOILER_OPEN_TOKEN = "dzzy_spoiler_open";
const SPOILER_CLOSE_TOKEN = "dzzy_spoiler_close";
...
export function registerSpoilerMarkdownIt(
  ...
  md.renderer.rules[SPOILER_OPEN_TOKEN] = () =>
    '<span data-spoiler="" class="dzzy-spoiler">';
