...
import * as DzzyTheme from "@/app/DzzyThemeSurfaces";
...
export function AppShell() {
  ...
  // Dispatch `dzzy://message` deep links into the router.
  useMessageDeepLinks();
        ...
        >
          <HuddleProvider>
            <RemindMeLaterProvider pubkey={identityQuery.data?.pubkey}>
              <div
                className="dzzy-huddle-shell relative h-dvh overflow-hidden overscroll-none"
                data-huddle-open={isHuddleDrawerOpen}
              >
                <div
                  className={cn(
                    "dzzy-huddle-app-surface z-10 flex min-h-0 flex-row overflow-hidden bg-background",
                    isHuddleDrawerOpen && "dzzy-huddle-app-surface-open",
                  )}
                >
                  <DzzyTheme.GradientLayer />
                  {hasCommunityRail ? (
                    <CommunityRail
                      activeCommunityId={
                      ...
                      <div className="flex min-h-0 flex-1 overflow-hidden">
                        ...
                        <MainInsetProvider mainInsetRef={mainInsetRef}>
                          <SidebarInset
                            ...
                            data-dzzy-glass-inset
                            data-dzzy-shadow-viewport
                            style={chromeCssVarDefaults as React.CSSProperties}
                          >
                            <DzzyTheme.ContentSurface>
                              <Outlet />
                            </DzzyTheme.ContentSurface>
                          </SidebarInset>
                        </MainInsetProvider>
                ...
                <div className="absolute inset-x-0 bottom-0 z-0 h-(--dzzy-huddle-drawer-height)">
                  <HuddleBar
                    className="h-full"
