...
// (dzzy-relay/src/handlers/ingest.rs). Eva's channel-window surface reads that
...
//
// Transport auth: the test relay runs DZZY_REQUIRE_AUTH_TOKEN=false
...
//
// Canonical tag shapes (crates/dzzy-sdk/src/builders.rs thread_tags + ingest):
