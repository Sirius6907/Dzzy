...
const overrides = new Map([
  ...
  // Git Bash readiness is intentionally colocated with dzzy-agent's other
  ...
  // Load-bearing — required for dzzy-agent normalized config parity.
  ...
  // Dzzy-managed Node path helpers and resolution tests moved to
  ...
  // to return "dzzy-desktop-dev" in debug builds. Load-bearing isolation fix.
  ...
  // +17: baked-env-global-unify: DZZY_AGENT_THINKING_EFFORT added to
  ...
  // global-agent-config: model-tuning section (DzzyAgentModelTuningFields via
  ...
  // call site and dzzy-agent auto-expand effect for model-tuning knob visibility.
  ...
  // +2 provider-aware effort: model/provider props threaded to DzzyAgentModelTuningFields.
