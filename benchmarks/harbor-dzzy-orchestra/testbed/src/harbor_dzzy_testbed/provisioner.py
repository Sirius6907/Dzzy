"""Channel-per-trial Dzzy provisioning against a local benchmark stack."""
...
class DzzyTrialProvisioner:
    """Implements the TrialHandle v1.1 contract against a live Dzzy relay.

    Guarantees (contract PLANS/HARBOR_DZZY_TRIALHANDLE_CONTRACT.md):
    ...
    def _provision(
        ...
        # mirroring production Dzzy, where a human owns the channel their
        # agents work in.
    ...
    def _cli_for(self, credential: AgentCredential) -> DzzyCli:
        return DzzyCli(
