"""Harbor custom-agent entry point for Dzzy orchestration."""
...
class DzzyOrchestraAgent(BaseAgent):
    """Coordinate an arbitrary manifest-defined team through a Dzzy trial."""
    ...
    def _build_runtime(
        ...
        dzzy_acp_binary: str,
        dzzy_agent_binary: str,
        dzzy_dev_mcp_binary: str,
        dzzy_cli_binary: str,
        relay_gateway: str,
        ...
        return DzzyContainerRuntime(
            ...
            endpoints=endpoints,
            dzzy_acp_binary=dzzy_acp_binary,
            dzzy_agent_binary=dzzy_agent_binary,
            dzzy_dev_mcp_binary=dzzy_dev_mcp_binary,
            dzzy_cli_binary=dzzy_cli_binary,
    ...
    async def run(
        ...
        if self.provisioner is None or self.runtime is None:
            raise RuntimeError(
                "DzzyOrchestraAgent requires provisioner and runtime integrations; "
        ...
        context.metadata = {
            **result.metadata,
            ...
            "dzzy_channel_id": handle.channel_id,
            "run_id": run_id,
            "trial_id": trial_id,
        }
