"""Typed boundary between the Harbor adapter and Dzzy trial provisioning."""
...
class AgentCredential:
    """One trial-scoped Dzzy identity and attributed LLM credential."""
...
@dataclass(frozen=True, slots=True)
class TrialHandle:
    """Provisioned Dzzy resources owned by one Harbor trial."""
...
class TrialProvisioner(Protocol):
    """Creates and tears down trial-isolated Dzzy resources synchronously."""
